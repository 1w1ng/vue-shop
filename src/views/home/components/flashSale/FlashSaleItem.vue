	...
	<div class="wrapper" data-index="3">
		<div class="itemWrapper">
			<div class="imageWrapper">
				<img :alt="product.spec" :src="product.small_image" class="image" />
			</div>
			<div>
				...
				<div class="priceWrapper">
					...
					<div class="iconCartWrapper">
						<svg class="icon icon-60" viewBox="0 0 52 52">
							<defs>
								<radialGradient
									cx="27.0288363%"
									cy="10.3693483%"
									...
									r="93.8427229%"
								>
									<stop offset="0%" stop-color="#4ECA75" />
									<stop offset="100%" stop-color="#39B460" />
								</radialGradient>
							</defs>
